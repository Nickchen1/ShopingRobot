...
static char UpdateLineSensor() {
  near_wire_sensor_state_real = digitalRead(FRONT_WIRE_SENSOR_NEAR_PIN) << 3 |
                                digitalRead(BACK_WIRE_SENSOR_NEAR_PIN)  << 2 |
                                digitalRead(LEFT_WIRE_SENSOR_NEAR_PIN)  << 1 |
                                digitalRead(RIGHT_WIRE_SENSOR_NEAR_PIN);
  ...
  front_line_sensor_state_real = digitalRead(FRONT_WIRE_SENSOR_S1_PIN) << 4 |
                                 ...
                                 digitalRead(FRONT_WIRE_SENSOR_S5_PIN) << 1 |
